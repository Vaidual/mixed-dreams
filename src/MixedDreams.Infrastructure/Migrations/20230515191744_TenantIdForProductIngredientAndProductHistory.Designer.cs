...
namespace MixedDreams.Infrastructure.Migrations
{
    ...
    [Migration("20230515191744_TenantIdForProductIngredientAndProductHistory")]
    partial class TenantIdForProductIngredientAndProductHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MixedDreams.Domain.Entities.BackblazeFile", b =>
                {
                    b.HasOne("MixedDreams.Domain.Entities.Product", "Product")
                        .WithOne("Image")
                        .HasForeignKey("MixedDreams.Domain.Entities.BackblazeFile", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
namespace MixedDreams.Application.Migrations
{
    ...
    [Migration("20230619135427_ProductPreparationFix")]
    partial class ProductPreparationFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MixedDreams.Domain.Entities.Cook", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentProductPreparationId")
                        .IsRequired()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("LastProductPreparationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MixedDreams.Domain.Entities.ProductPreparation", b =>
                {
                    ...
                    b.HasOne("MixedDreams.Domain.Entities.OrderProduct", "OrderProduct")
